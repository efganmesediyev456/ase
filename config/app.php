    ...
    */
    ...
    'debug' => (
        (isset($_SERVER['HTTP_CF_CONNECTING_IP']) &&
            ($_SERVER['HTTP_CF_CONNECTING_IP'] == '94.20.38.158' || $_SERVER['HTTP_CF_CONNECTING_IP'] == '46.22.229.187' || $_SERVER['HTTP_CF_CONNECTING_IP'] == '185.222.92.52')) ||
        env('APP_ENV') == 'local'
    ),
...
//        App\Providers\CustomLogServiceProvider::class,
        ...
        App\Providers\SaySayServiceProvider::class,
