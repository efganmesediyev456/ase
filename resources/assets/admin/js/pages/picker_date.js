...
$(function() {
    ...
    // Initialize with options
    $('.filter-daterange-ranges').daterangepicker(
        {
            startDate: $(".datepicker-range-start").val() != '' ? moment($(".datepicker-range-start").val(), 'YYYY-MM-DD') : moment().subtract(29, 'days'),
            endDate: $(".datepicker-range-end").val() != '' ? moment($(".datepicker-range-end").val(), 'YYYY-MM-DD') : moment(),
            minDate: '01/01/2017',
        ...
        function(start, end) {
            $('.filter-daterange-ranges span').html(start.format('MMMM D, YYYY') + ' &nbsp; - &nbsp; ' + end.format('MMMM D, YYYY'));
            $(".datepicker-range-start").val(start.format('YYYY-MM-DD'));
            $(".datepicker-range-end").val(end.format('YYYY-MM-DD'));
        }
    );

    // Display date format
    if ($(".datepicker-range-start").val() != '') {
        $('.filter-daterange-ranges span').html(moment($(".datepicker-range-start").val()).format('MMMM D, YYYY') + ' &nbsp; - &nbsp; ' + moment($(".datepicker-range-end").val()).format('MMMM D, YYYY'));
    } else {
        $('.filter-daterange-ranges span').html('All time');
    }
    ...
    $('#pickadate').pickadate({
        ...
        hiddenSuffix: $('#pickadate').data('name')
    });
