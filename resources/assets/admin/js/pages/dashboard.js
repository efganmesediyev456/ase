...
$(function() {
    ...
    // ------------------------------
    if ($("#monthly-sales-stats").length > 0)
    ...
    generateBarChart("#members-online", 24, 40, true, "elastic", 1200, 50, "#5c7cd0", "hours");
