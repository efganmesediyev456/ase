...
<table style="width: 1200px">
    ...
    <tr>
        <td style="color: #fff">-</td>
        <td colspan="{{ $span - 6 }}">{{ $warehouse->country->name }}</td>
        <td style="color: #fff">-</td>
    ...
    @foreach($packages as $key => $package)
        <tr>
            ...
            <td>
                <span>         </span>{{ ($package->type ? ($package->type->translate('en') ? ($package->type->translate('en')->name . ($package->other_type ? "(" . $package->other_type .")" : null)) : "-") : '-') }}
            </td>
