            ...
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <form method="post"
                        ...
                        {{--                            Keşi sil--}}
                        {{--                        </button>--}}
{{--                        @if($container->status === \App\Models\Surat\SuratOrder::STATUSES['WAITING'])--}}
...
{{--                        @endif--}}
                        ...
                        <button class="btn btn-success"
                                data-url="{{ route('surat.send-packages', $container->id) }}?temu=true"
                        >
                            Göndər Temu
                        </button>
                    </form>
    ...
    <div class="card" style="max-width: 300px">
        <div class="card-header">
            <form method="get"
                  action="{{ route('surat.containers.edit', $container->id) }}"
                  class="form-prevent-multiple-submits"
            >
    ...
    ? (isset($row->track) ? $row->track->status : null)
    : (isset($row->package) ? $row->package->status : null);
                                    @endphp
