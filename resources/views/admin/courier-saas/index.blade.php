...
@section('title', 'Surat Kargo Dashboard')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            @include('admin.surat.index_filter')
                            ...
                            <table class="table">
                                ...
                                @foreach($packages as $package)
                                    <tr>
                                        ...
                                        <td>
                                            <b>{{ __('admin.surat_warehouse_package_status_'.$package->status) }}</b>
                                        </td>
                                        <td>
                                            <a href="{{ route('surat.containers.edit', $package->container->id) }}"><b>{{ $package->container->name }}</b></a>
                                        </td>
