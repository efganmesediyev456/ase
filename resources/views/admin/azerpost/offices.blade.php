...
@section('content')
        ...
        <div class="card_body">
            <div class="box box-primary pt-15">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-8">
                            <form method="post" action="{{ route('azerpost.offices') }}">
            ...
            @if($offices->count() > 0)
                <div class="box box-primary mt-15 ml-10 mr-10">
                    <div class="box-body table-responsive no-padding">
                        <form method="post" action="{{ route('azerpost.index') }}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            ...
                            <table class="table table-hover table-striped">
                                ...
                                @foreach($offices as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <button onclick="editOffice({{$row->id}}, '{{ json_encode($row) }}', '{{ route('azerpost.offices.update', $row->id) }}')"
                                                    class="btn btn-primary" type="button">
                                                <i class="icon-pencil"></i>
                                            </button>
                                            <button
                                                    formaction="{{ route('azerpost.offices.delete', $row->id) }}"
    ...
    <div class="modal edit-modal fade" id="editOfficeModal" role="dialog"
        ...
        <div class="modal-dialog modal-sm" role="document">
            <form action="{{ route('azerpost.offices') }}" method="post" id="officeForm">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="div" style="position: relative">
                            ...
                            <div class="form-group">
                                <label for="note">Description (En):</label>
