                ...
                <div class="panel-heading">
                    ...
                    <div class="heading-elements">
                        ...
                        @if($extraButtons)
                            ...
                            @endforeach
                        @endif
                            <button id="topluTehvilVer" class="btn btn-primary">Toplu Tehvil Ver</button>
...
{{--        $('#topluTehvilVer').on('click', function () {--}}
{{--            let selectedItems = [];--}}
...
{{--            const endpoint = '{{ route("packages.changeStatusAllDone") }}';--}}
