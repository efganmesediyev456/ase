...
@section('content')
        ...
        <div class="card_body">
            <div class="box box-primary pt-15">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-8">
                            <form method="post" action="{{ route('azeriexpress.offices') }}">
            ...
            @if($offices->count() > 0)
                <div class="box box-primary mt-15 ml-10 mr-10">
                    <div class="box-body table-responsive no-padding">
                        <form method="post" action="{{ route('azeriexpress.index') }}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button
                                                    ...
                                                    onclick="editOffice(
        {{ $row->id }},
        JSON.parse(atob('{{ base64_encode(json_encode($row)) }}')),
        '{{ route('azeriexpress.offices.update', $row->id) }}'
    )"
                                            >
                                            ...
                                            <button
                                                    formaction="{{ route('azeriexpress.offices.delete', $row->id) }}"
    ...
    <div class="modal edit-modal fade" id="editOfficeModal" role="dialog"
        ...
        <div class="modal-dialog modal-sm" role="document">
            <form action="{{ route('azeriexpress.offices') }}" method="post" id="officeForm">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
