        ...
        <div class="card_body">
            <div class="box box-primary p-15">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-8">
                            <form method="post" action="{{ route('azeriexpress.containers') }}">
                                    ...
                                    <tr>
                                        <td class="text-right">
                                            <div style="display: flex">
                                                <a href="{{route('azeriexpress.containers.edit', $row->id)}}"
                                        ...
                                        <td>{{ $row->sent_at }}</td>
                                        <td>
                                            <a href="{{ route('containerSend', ['id' => $row->id, 'type' => 'azeri_express']) }}"
                                               class="btn btn-success" type="button">
                                                <span class="text-white">Göndər</span>
                                            </a>
                                            <a href="{{ route('containerCheck', ['id' => $row->id, 'type' => 'azeriexpress']) }}"
                                            ...
                                            <button
                                                    formaction="{{ route('azeriexpress.delete_group', $row->id) }}"
