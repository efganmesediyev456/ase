    ...
    <tbody>
        @foreach($packages as $package)
            <tr>
                ...
                <td>{{ __('admin.azerpost_warehouse_package_status_' . $package->status) }}</td>
                        <td>@if($package->container)
                                @if($package->container->azerpostOffice)
                                    {{ $package->container->azerpostOffice->name }}
                                @endif
                            @endif
                        </td>
            </tr>
