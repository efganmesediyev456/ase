...
@section('content')
    <div class="col-lg-12 col-lg-offset-0 col-md-12 col-xs-12 bg-white p-20">
        ...
        @endif
        <form action="{{ route('courier.shelf.edit.post',$shelf->id) }}" method="POST">
            ...
            <div class="col-lg-4 col-lg-offset-0 col-md-6 col-xs-12">
                ...
                <input type="text" class="form-control" maxlength="6" value="{{ $shelf->barcode }}" name="barcode" required>
                ...
                <select name="courier_id" id="courier_id" class="form-control" required>
                    ...
                    @foreach($couriers as $courier)
                        <option value="{{ $courier->id }}" @if($courier->id == $shelf->courier_id) selected @endif>{{ $courier->name }}</option>
                    @endforeach
                </select>
            </div>
