...
<head>
    ...
    <style>
        ...
        .borderly {
@if (isset($shipper->country->code) && $shipper->country->code == 'us' && ($item->tracking_code))
@else
        ...
        <div class="row">
            <div class="col-5 table-left">
                    ...
                    <div class="row">
                        <div class="col-12">
                            @if($shipper)
                                ...
                                <p class="ml-2" style="font-family: firefly, DejaVu Sans, sans-serif;">{{ $item->website_name }} <br>
                                    @if ($shipper)
                ...
                <div id="table-left-recipient">
                    <div class="row">
                        <div class="col-12">
                            <p><b>RECIPIENT:</b> <i>{{$item->user ? ($item->user->company && $item->user->voen) ? $item->user->company : $item->user->full_name : '-' }}</i> <br></p>
                            <p class="ml-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-7 cold-7">
                            <p>
                                ...
                                <i>Std</i><br/>
                               <i style="font-family: firefly, DejaVu Sans, sans-serif;"><?= $item->detailed_type . ($item->other_type ? "(" . $item->other_type .")" : null) ?></i>
                            </p>
                        </div>
                    </div>
                </div>
