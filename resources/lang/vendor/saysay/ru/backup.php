...
return [
    ...
    */
    ...
    'delete_confirmation_message' => 'Резервная копия была удалена.',
    'delete_error_title' => 'ошибка',
    'delete_error_message' => 'Файл резервной копии НЕ был удален.',
    'delete_cancel_title' => "Все OK",
    'delete_cancel_message' => 'Файл резервной копии НЕ был удален.',
    'create_confirmation_title' => 'Создание резервной копии завершено',
    'create_confirmation_message' => 'Перезагрузка страницы через 3 секунды.',
    'create_error_title' => 'Ошибка резервного копирования',
    'create_error_message' => 'Невозможно создать резервную копию файла.',
    'create_warning_title' => 'Неизвестная ошибка',
    'create_warning_message' => 'Возможно, ваша резервная копия НЕ создана. Пожалуйста, проверьте файлы журналов для деталей.',
