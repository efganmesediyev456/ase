...
//        }
        ...
        foreach ($packages as $package) {
            ...
            Log::channel('yenipoct')->info("YeniPoct createOrder API call started", [
                'body' => $arr
            ]);
            ...
            if (isset($response["status"]) and $response["status"]) {
                ...
                if ($response["status"] == 'ok') {
                    ...
                    Log::channel('yenipoct')->error("Yeni poct createOrder Error", [
                        'barcode' => $package->barcode,
                        'stack_trace' => json_encode($result)
                    ]);
