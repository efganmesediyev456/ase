...
class KargomatOfficeController extends Controller
{
    public function offices(Request $request)
    {
        $offices = KargomatOffice::paginate(15);

        return view('admin.kargomat.offices', compact('offices'));
    }
    ...
    public function storeOffice(Request $request)
    {
        ...
        KargomatOffice::query()->create([
            'name' => $validatedData['name'],
            'name_en' => $validatedData['name'] ?? null,
            'foreign_id' => $validatedData['foreign_id'] ?? 0,
            'description' => $validatedData['description'],
            'description_en' => $validatedData['description'] ?? null,
            'address' => $validatedData['address'],
            'address_en' => $validatedData['address'] ?? null,
    ...
    public function updateOffice(Request $request): RedirectResponse
    {
        ...
        KargomatOffice::where('id', $request->input('id'))->update([
            'name' => $validatedData['name'],
