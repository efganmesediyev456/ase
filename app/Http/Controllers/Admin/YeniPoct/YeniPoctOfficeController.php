...
class YeniPoctOfficeController extends Controller
{
    public function offices(Request $request)
    {
        $offices = YeniPoctOffice::paginate(15);

        return view('admin.yenipoct.offices', compact('offices'));
    }
    ...
    public function updateOffice(Request $request): RedirectResponse
    {
        ...
        YeniPoctOffice::where('id', $request->input('id'))->update([
            'name' => $validatedData['name'],
            'name_en' => $validatedData['name_en'] ?? null,
            'description' => $validatedData['description'],
            'foreign_id' => $validatedData['foreign_id'] ?? 0,
